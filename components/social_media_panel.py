...
def _render_youtube_tab(
    ...
    with sub_tabs[0]:
        _render_video_list(youtube_data.get("reviews") or [], "reviews")

    with sub_tabs[1]:
        _render_video_list(youtube_data.get("unboxings") or [], "unboxings")

    with sub_tabs[2]:
        _render_video_list(youtube_data.get("comparisons") or [], "comparisons")

    with sub_tabs[3]:
        _render_video_list(youtube_data.get("general") or [], "general")
