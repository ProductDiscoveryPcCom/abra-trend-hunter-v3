...
def render_related_queries(
    ...
    with st.expander("ℹ️ ¿Qué significan los indicadores?"):
        ...
        - **🚀 Breakout (XX)**: Crecimiento explosivo (+5000% o más). El número XX es el **Breakout Score** (0-100):
          ...
          - El score considera: posición en ranking, tipo de entidad, y volumen relativo
        ...
        💡 **Tip**: Usa el Breakout Score para comparar queries entre marcas diferentes y priorizar cuáles analizar primero.
        """)
