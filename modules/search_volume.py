...
⚠️ IMPORTANTE: Este módulo genera ESTIMACIONES, NO datos reales de Google.

El índice de Google Trends (0-100) es relativo, no representa volúmenes absolutos.
Las estimaciones aquí calculadas son aproximaciones basadas en heurísticas.

Para volúmenes de búsqueda REALES, necesitas integrar:
- Google Ads API (Keyword Planner) - requiere cuenta con historial de gasto
- DataForSEO API (~50€/mes) - https://dataforseo.com
- Semrush API (~100€/mes) - https://semrush.com
- Ahrefs API (~100€/mes) - https://ahrefs.com

Fuentes utilizadas para estimaciones (NO son datos reales):
- Google Trends (índice 0-100 relativo)
- Google Search Results (número de resultados)
- Factores de categoría y región (heurísticos)
"""
