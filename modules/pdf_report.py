...
class TrendReportPDF:
    ...
    def _add_trend_analysis(
        ...
        """Añade sección de análisis de tendencia"""
        self.elements.append(Paragraph(
        ...
        if trend_values and len(trend_values) > 0:
            ...
            # Datos (solo últimos 52 puntos para legibilidad)
    ...
    def _add_seasonality(self, seasonality_data: Dict[str, Any]):
        """Añade sección de estacionalidad"""
        self.elements.append(Paragraph(
            "📅 Estacionalidad",
            self.styles['SectionTitle']
        ))
        ...
        if is_seasonal:
            ...
            if monthly:
                ...
                # Dividir en dos filas para mejor visualización
                if len(data) > 7:
