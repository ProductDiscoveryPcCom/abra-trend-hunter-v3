...
try:
    from modules.api_usage import log_serpapi_call
except ImportError:
    def log_serpapi_call(*args, **kwargs): pass
...
class GoogleTrendsModule:
    ...
    def get_interest_over_time(
        ...
        try:
            # Intentar con reintentos para manejar timeouts temporales
            max_retries = 2
            last_error = None
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    log_serpapi_call(
                        endpoint="google_trends_timeseries",
                        keyword=keyword,
                        cached=False,
                        success=True
                    )
